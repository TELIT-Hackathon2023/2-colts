<script setup>
import JiraTicketPopup from "../lib/JiraTicketPopup.vue";
</script>

<template>
  <JiraTicketPopup v-if="isJiraPopup"></JiraTicketPopup>
  <section>
    <h3>Chat</h3>
    <div class="chat">
      <div v-for="(pair, index) in answer" :key="index" class="chat__entry">
        <header>
          <span class="question">
            {{ pair.initial }}
          </span>
          <div class="buttons">
            ...
            <button class="reaction" @click="isJiraPopup = true">
